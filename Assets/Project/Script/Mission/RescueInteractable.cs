...
public class RescueInteractable : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        // Draw interaction prompt - positioned at the animal's head level
        ...
        if (screenPos.z > 0)
        {
            ...
            if (isRescuing)
            {
                ...
                GUI.Label(new Rect(screenPos.x - 125, Screen.height - screenPos.y - 20, 150, 20), 
            ...
            // Animal name below the prompt
            style.fontSize = 12;
            style.normal.textColor = Color.white;
            GUI.Label(new Rect(screenPos.x - 125, Screen.height - screenPos.y, 150, 18), 
                      animalName, style);
        }
    }
