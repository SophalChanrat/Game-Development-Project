...
public class DialogueManager : MonoBehaviour
{
    ...
    [SerializeField] private Image backgroundImage; // UI Image for background
    ...
    [SerializeField] private List<Sprite> backgroundImages = new List<Sprite>(); // Store background sprites
    ...
    private void Update()
    {
        // Advance dialogue on mouse click
    ...
    private void ChangeBackground(int dialogueIndex)
    {
        ...
        {
            if (backgroundImages[dialogueIndex] != null)
            {
                backgroundImage.sprite = backgroundImages[dialogueIndex];
                Debug.Log("Background changed to image " + dialogueIndex);
            }
        }
    }
}